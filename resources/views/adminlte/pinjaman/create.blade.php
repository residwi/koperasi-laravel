                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input id="tgl_lahir" type="text" class="form-control"
                            value="{{ \Carbon\Carbon::parse($anggota->tgl_lahir)->format('d-m-Y') }}" disabled>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="perusahaan" class="form-control" value="{{ $anggota->perusahaan }}"
                            disabled>
                    </div>
                    <div class="form-group">
                        <label for="nik">No NIK</label>
                        <input type="text" id="nik" class="form-control" value="{{ $anggota->nik }}" disabled>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input id="tgl_nik" type="text" class="form-control"
                                value="{{ \Carbon\Carbon::parse($anggota->tgl_nik)->format('d-m-Y') }}" disabled>
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="divisi" class="form-control" value="{{ $anggota->divisi }}" disabled>
                    </div>
                    <div class="form-group">
                        <label for="bagian">Bagian</label>
                        <input type="text" id="bagian" class="form-control" value="{{ $anggota->bagian }}" disabled>
                    </div>
                    <div class="form-group">
                        <label for="golongan">Golongan</label>
                        <input type="text" id="golongan" class="form-control" value="{{ $anggota->golongan }}" disabled>
                    </div>
                </div>
            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" id="upah_pokok"
                                value="{{ number_format($anggota->upah_pokok) }}" disabled>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" id="gaji"
                                value="{{ number_format($anggota->gaji) }}" disabled>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" id="tunjangan_jabatan"
                                value="{{ number_format($anggota->tunjangan_jabatan) }}" disabled>
                        </div>
                    </div>
                </div>
            </div>
